...
namespace bazy1.ViewModels.Receptionist.Pages
{
    public class PatientListViewModel : ViewModelBase
    {
        ...
        private readonly ReceptionistViewModel viewModel;
        ...
        public PatientListViewModel(ReceptionistViewModel viewModel)
        {
            ...
            EditPatientCommand = new BasicCommand(obj =>
            {
        ...
        public Patient SelectedPatient
        {
            ...
            set
            {
                ...
                OnPropertyChanged(nameof(PatientDetails));
            }
        }
        ...
        public string FilterText
        {
            ...
            set
            {
                ...
                {
                    if (patient is Patient tempPatient)
                    {
        ...
        public string PatientDetails
        {
            get
            {
                ...
                if (SelectedPatient != null)
                {
                    var tempPatient = DbContext.Patients.Where(pat => pat.Id == SelectedPatient.Id).FirstOrDefault();
                    if (tempPatient != null)
                    {
